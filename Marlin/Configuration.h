...
#define STRING_CONFIG_H_AUTHOR "(Augusto Zanellato, ArtilleryMarlinSKR)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, -33, -0.75 }
...
//#define RGBW_LED
  ...
  #define RGB_LED_R_PIN PA4
  #define RGB_LED_G_PIN PA7
  #define RGB_LED_B_PIN PA5
